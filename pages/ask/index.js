...
export default function Coinflip(){
    const answers = ["yes", "no", "nah", "not today", "yeah", "go for it", "today is your day", "I wouldn't suggest it", "free elo today", "not too free but go", "semi free",
                        ...
                        "yes but ARAM only", "play one aram for good luck then to solo", "360 on chair before queue", "!!!!! YOUR JUNGLER IS OFF THE LEASH, DONT QUEUE", "your lobby will have 2/5 bots today",
                        "your lobby will have 5/5 bots today","yessir", "yes but drink water and keep a good posture", "meditate 5 mins and go", "yes but jg only", "yes but sololane only", "yes but bot only",
